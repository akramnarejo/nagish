        ...
        <div>
            ...
            <main className="h-[35rem] md:h-[50rem]">
                <div className='flex flex-col text-center justify-center items-center h-full'>
                    <p className='text-4xl md:text-6xl lg:text-8xl font-bold'>Call Ended</p>
                    <div className='flex flex-col justify-center items-center mt-16 lg:mt-28 text-xl font-bold'>
